use crate::{
    next_identity, Alternative, Combinator, Deferred, Fail, Formable, Identity, Ignore, Literal,
    Multiple, Offset, Optional, Outcome, Panic, Peekable, Predicate, Recover, Repetition, Scale,
